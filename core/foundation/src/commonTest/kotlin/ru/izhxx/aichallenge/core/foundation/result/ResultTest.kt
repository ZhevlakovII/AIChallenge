...
class ResultTest {
    ...
    fun `onFailure invokes and chains`() {
        ...
        val domainError = AppError.DomainError(code = "domain.test", rawMessage = "boom")
    ...
    fun `getSuccessOrNull returns correct value`() {
        ...
        val failureResult: AppResult<Int> = AppResult.failure(AppError.UnknownError(rawMessage = "x"))
