...
- Эндпоинт MCP (WebSocket): ws://localhost:8080/mcp
- Доступные инструменты:
  - health_check — состояние MCP сервера
  - get_time — текущее время сервера (ISO-8601 UTC)
  - get_rub_usd_rate — текущий курс RUB→USD по exchangerate.host
  - echo — эхо
  - sum — сумма двух чисел
  - github.list_user_repos — публичные репозитории пользователя
  - github.list_my_repos — репозитории аутентифицированного пользователя (требуется GITHUB_TOKEN)
